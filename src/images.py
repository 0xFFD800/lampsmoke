...
def bg_hills_trees(gObj) :
    ...
    # Hill 1
    draw_tree(gObj, 100, 265, 3)
    draw_tree(gObj, 200, 255, 2)
    draw_tree(gObj, 130, 252, 2)
    draw_tree(gObj, 80, 290, 2)
    draw_tree(gObj, 30, 295, 3)
    draw_tree(gObj, 140, 265, 2)
    draw_tree(gObj, 220, 260, 3)
    draw_tree(gObj, 250, 235, 3)
    draw_tree(gObj, 260, 265, 2)
    draw_tree(gObj, 310, 240, 2)
    draw_tree(gObj, 330, 260, 3)
    draw_tree(gObj, 370, 225, 3)
    draw_tree(gObj, 420, 235, 3)
    draw_tree(gObj, 450, 265, 2)
    draw_tree(gObj, 470, 260, 3)
    draw_tree(gObj, 510, 285, 2)

    # Hill 2
    draw_tree(gObj, 590, 285, 2)
    draw_tree(gObj, 625, 245, 3)
    draw_tree(gObj, 645, 265, 3)
    draw_tree(gObj, 630, 235, 2)
    draw_tree(gObj, 640, 255, 3)
    draw_tree(gObj, 670, 225, 2)
    draw_tree(gObj, 655, 235, 2)
    draw_tree(gObj, 685, 255, 2)
    draw_tree(gObj, 700, 215, 2)
    draw_tree(gObj, 725, 225, 3)
    draw_tree(gObj, 740, 235, 3)
    draw_tree(gObj, 770, 255, 3)
    draw_tree(gObj, 780, 205, 2)
    draw_tree(gObj, 755, 185, 2)
    draw_tree(gObj, 805, 195, 3)
    draw_tree(gObj, 830, 175, 4)
    draw_tree(gObj, 845, 180, 2)
    draw_tree(gObj, 850, 195, 2)
    draw_tree(gObj, 860, 220, 3)
    draw_tree(gObj, 890, 205, 3)
    draw_tree(gObj, 825, 225, 2)
    draw_tree(gObj, 900, 235, 2)
    draw_tree(gObj, 925, 245, 2)
    draw_tree(gObj, 935, 235, 2)

    # Hill 3
    draw_tree(gObj, 1000, 265, 3)
    draw_tree(gObj, 1200, 235, 2)
    draw_tree(gObj, 1130, 232, 2)
    draw_tree(gObj, 1080, 250, 2)
    draw_tree(gObj, 1030, 265, 3)
    draw_tree(gObj, 1140, 285, 2)
    draw_tree(gObj, 1220, 240, 3)
    draw_tree(gObj, 1250, 215, 3)
    draw_tree(gObj, 1260, 225, 2)
    draw_tree(gObj, 1310, 200, 2)
    draw_tree(gObj, 1330, 250, 3)
    draw_tree(gObj, 1370, 205, 3)
    draw_tree(gObj, 1420, 195, 3)
    draw_tree(gObj, 1450, 245, 2)
    draw_tree(gObj, 1470, 220, 3)
    draw_tree(gObj, 1510, 255, 2)
    draw_tree(gObj, 1020, 285, 3)
    draw_tree(gObj, 1210, 245, 2)
    draw_tree(gObj, 1115, 239, 2)
    draw_tree(gObj, 1070, 280, 2)
    draw_tree(gObj, 1050, 275, 3)
    draw_tree(gObj, 1130, 300, 2)
    draw_tree(gObj, 1230, 250, 3)
    draw_tree(gObj, 1265, 225, 3)
    draw_tree(gObj, 1270, 255, 2)
    draw_tree(gObj, 1300, 220, 2)
    draw_tree(gObj, 1315, 240, 3)
    draw_tree(gObj, 1390, 225, 3)
    draw_tree(gObj, 1415, 310, 3)
    draw_tree(gObj, 1460, 235, 2)
    draw_tree(gObj, 1490, 240, 3)
    draw_tree(gObj, 1480, 275, 2)
